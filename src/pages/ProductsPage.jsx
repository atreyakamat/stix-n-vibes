        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Discover our complete collection of stickers, posters, and custom designs. Everything you need to express yourself.
            </p>
            <motion.div
        ...
        <div className="text-center py-20">
          ...
          >
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              Products Catalog Coming Soon
            </h2>
            <p className="text-gray-600 text-lg mb-8">
              We're organizing our complete product collection. Visit our Shop for available items!
            </p>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <a href="/shop" className="bg-gradient-to-r from-[#e92932] to-[#ff6b9d] text-white px-8 py-3 rounded-full font-semibold text-lg hover:shadow-lg transition-all duration-300 inline-block">
                Visit Shop Now
              </a>
            </motion.div>
          </motion.div>
